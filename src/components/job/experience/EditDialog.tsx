...
interface JobExperienceEditDialogProps {
  id: string;
  onUpdated: () => void;
}

export default function JobExperienceEditDialog({
  id,
  onUpdated
}: JobExperienceEditDialogProps) {
  ...
  const handleSaveClick = async () => {
    try {
      await updateJobExperience(id, values);
      setOpen(false);
      onUpdated();
      toast("Job experience updated successfully.", { type: "success" });
    } catch (err: any) {
