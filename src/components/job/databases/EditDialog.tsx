...
interface JobDatabaseEditDialogProps {
  id: string;
  onUpdated: () => void;
}

export default function JobDatabaseEditDialog({
  id,
  onUpdated
}: JobDatabaseEditDialogProps) {
  ...
  const handleSaveClick = async () => {
    try {
      await updateJobDatabase(id, values);
      setOpen(false);
      onUpdated();
      toast("Job database updated successfully.", { type: "success" });
    } catch (err: any) {
